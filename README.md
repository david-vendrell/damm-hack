...
> **Pitch:** Blue Yonder tells you what the plan *should* be. LineWise tells you what reality says will actually happen — and rearranges your week when an urgent order lands.
...
cd damm-hack
pip install -r requirements.txt   # duckdb pandas openpyxl + report deps
